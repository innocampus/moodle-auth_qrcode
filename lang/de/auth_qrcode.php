...
$string['invalid_token_or_expired'] = 'Ihre Anmelde-Anfrage ist ungültig oder abgelaufen. Bitte scannen Sie einen neuen QR-Code.';
...
$string['login_successful'] = 'Anmeldung erfolgreich.';
$string['login_using_smartphone'] = 'Anmeldung per Smartphone';
$string['login_via_qrcode'] = 'Anmeldung per QR-Code';
