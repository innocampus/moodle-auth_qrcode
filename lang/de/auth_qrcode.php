...
$string['expired_or_rejected'] = 'Ihr Token ist entweder abgelaufen oder abgelehnt worden. Bitte scannen Sie einen neuen QR-Code.';
...
$string['login_using_smartphonee'] = 'Anmeldung per Smartphone';
...
$string['return_to_login'] = 'Zur Anmeldung zurückkehren';
$string['task:cleanup_expired_qrcode'] = 'Abgelaufene QR-Login-Einträge bereinigen';
$string['userauthenticated'] = 'Benutzer über QR-Code authentifiziert';
